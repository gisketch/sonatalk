...
- *(If room is dead / wifi dead: press `O` on next slide, do the fake demo, nothing else changes.)*

## 8 · Workflow demo LIVE — 2.5 min ← the heart
...
## 10 · The Reveal — 1 min ← land the thesis
